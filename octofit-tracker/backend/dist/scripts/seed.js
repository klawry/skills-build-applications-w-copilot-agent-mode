...
async function seedDatabase() {
    try {
        ...
        const [trailblazersTeam, sprintSquadTeam] = await Team_1.Team.create([
            {
                name: 'Trailblazers',
                city: 'Seattle',
        ...
        const [maya, jordan, priya, liam] = await User_1.User.create([
            {
                name: 'Maya Chen',
        ...
        await Promise.all([
            Team_1.Team.findByIdAndUpdate(trailblazersTeam._id, { members: [maya._id, jordan._id] }),
            Team_1.Team.findByIdAndUpdate(sprintSquadTeam._id, { members: [priya._id, liam._id] }),
        ]);
        ...
        const [usersCount, teamsCount, activitiesCount, leaderboardCount, workoutsCount] = await Promise.all([
            ...
            Leaderboard_1.LeaderboardEntry.countDocuments(),
